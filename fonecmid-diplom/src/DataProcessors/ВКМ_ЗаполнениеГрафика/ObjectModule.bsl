	...
	Для к = 0 По Набор.Количество()-1 Цикл
		...
		ИначеЕсли Запись.Дата =Дат Тогда
			Если Найти(ВыходныеДни, Строка(ДеньНедели(Дат))) Тогда
				Запись.Значение = 0;
				Запись.ВидДня = Перечисления.ВКМ_ВидыДнейКалендаря.Выходной;
			Иначе	          
				Запись.Значение = 8;
				Запись.ВидДня = Перечисления.ВКМ_ВидыДнейКалендаря.Рабочий;
			КонецЕсли;
		...
		Иначе
			Пока Дат < Мин(Запись.Дата, ДатаОкончания) Цикл
				...
				Если Найти(ВыходныеДни, Строка(ДеньНедели(Дат))) Тогда
					...
					НоваяЗапись.ВидДня = Перечисления.ВКМ_ВидыДнейКалендаря.Выходной;
				Иначе	          
					НоваяЗапись.Значение = 8;
					НоваяЗапись.ВидДня = Перечисления.ВКМ_ВидыДнейКалендаря.Рабочий;
				КонецЕсли; 
				Дат = Дат + ЧислоСекундВСутках;
			КонецЦикла; 
